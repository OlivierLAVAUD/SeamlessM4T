...
This API provides a unified interface to leverage Meta's **SeamlessM4T v2** model, offering four core multilingual translation and transcription services:

- **Speech-to-Speech Translation (S2ST)** : Direct speech translation between languages
- **Speech-to-Text Translation (S2TT)** : Speech transcription with optional translation
- **Text-to-Speech Translation (T2ST)** : Multilingual speech synthesis
- **Text-to-Text Translation (T2TT)** : Text translation across languages
...
- **Unified Interface**: Single API for all translation services
- **High Performance**: Optimized for CUDA 12.6 and modern GPUs
- **Easy Deployment**: Docker and source code installation options
- **Interactive UI**: Gradio interface for easy testing
- **Batch Processing**: Support for processing multiple files
- **UV Package Management**: Fast dependency installation with uv
...
- **Note**: A NVIDIA GeForce RTX 3060 with 6GB VRAM is sufficient.
- **Disk space**: 10GB+ (20GB+ recommended for model downloads and caches)
...
```bash
# Launch both API and Gradio (default)
python main.py
...
© 2026 Olivier LAVAUD | Facebook-SeamlessM4T model | Version 1.0.0